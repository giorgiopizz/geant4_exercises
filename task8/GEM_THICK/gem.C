...
int main(int argc, char * argv[]) {
  ...
  gas->EnablePenningTransfer(rPenning, lambdaPenning, "ar"); // può essre eccitato l'argon, e rimanere in stato intermedio con en di binding > prima ecc. CO2
  ...
  AvalancheMC* drift = new AvalancheMC();   // drift con metodo monte carlo
