...
int main(int argc, char * argv[])
{
    ...
    for (unsigned int i = 0; i < nEvents; ++i)
    {
        ...
        double center_gauss = egamma/(25000-1000)*900;
    ...
    c.SetLogy();
    graph->SetTitle("Curva Assorbimento Kr 70%, Co2 30%;Photon Energy [eV];Photoelectrons");
    ...
    // c1.cd();
    // hElectrons.Draw();
    c.SaveAs("absorption_Kr70_Co230_gauss.png");
