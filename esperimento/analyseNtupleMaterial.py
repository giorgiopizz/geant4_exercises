...
from ROOT import TCanvas, TF1, TFile, TGaxis, TH1D, TGraph, TNtuple, Double_t
...
def analyseDecay(fname):
    global file, c1, c2, c3, c4, histo_tot
    ...
    histo_tot = TH1D("histotot", "histo tot", 40, 0, 11)
    ntuple_tot = file.Get("ntuple_tot")
    for event in ntuple_tot:
        histo_tot.Fill(event.decay)
