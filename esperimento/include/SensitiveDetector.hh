...
#include "MyHit.hh" //our hit format
...
private:
  // typedef std::map<G4int,Hit*> hitMap_t; //< Helper mapping layer number with hit
  // hitMap_t hitMap;

  HitCollection* hitCollection;          //< Collection of hits in the gas
  G4int HCID = -1;
